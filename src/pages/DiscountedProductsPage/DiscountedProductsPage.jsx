...
useEffect(() => {
    const filterAndSortProducts = () => {
        ...
        //     const productPrice = product.discont_prise || product.price
        //     if(productPrice < minPrice || productPrice > maxPrice ) return false
        //     if(includeDiscount && !product.discont_prise) return false
        //     return true
        // })
        ...
        .filter((product) => {
          ...
          const discountedPrice = product.discont_price || product.price;
